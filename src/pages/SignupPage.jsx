      ...
      <div className="su-root">
        ...
        <div className="su-left">
          <div className="su-form-wrap">
            ...
            <button type="button" onClick={() => useAuthStore.getState().loginWithGoogle()} className="su-google-btn">
...
function SignupStyles() {
  return (
    <style>{`
      ...
      .su-divider::before { margin-right: 12px; }
      .su-divider::after { margin-left: 12px; }
      ...
      .su-google-btn:hover {
        background: var(--su-bg);
        border-color: var(--su-text3);
        transform: translateY(-1px);
      }
      .su-google-btn:active { transform: scale(0.98); }
